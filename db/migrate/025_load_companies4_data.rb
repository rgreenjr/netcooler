...
class LoadCompanies4Data < ActiveRecord::Migration

  # fast growing tech companies 2007

  def self.up
    Company.transaction do
      YAML::load_file(File.join(File.dirname(__FILE__), "data", "companies4.yml")).each_value do |entry|
        begin
          company               = Company.new
          ...
          # puts office.valid?
          # puts office.errors.each {|e| puts e}
